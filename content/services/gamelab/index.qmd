...
<button class="nav-link" id="pills-magazines-tab" data-bs-toggle="pill" data-bs-target="#pills-magazines" type="button" role="tab" aria-controls="pills-program" aria-selected="false">
...
<img src="./magazines.jpeg" alt="Video Game Magazines" style="width: 40%; float: left; margin-right: 20px; margin-top: 8px;" />
